/*
  ...
  - You are about to drop the column `countyId` on the `OrderAddress` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "OrderAddress" DROP CONSTRAINT "OrderAddress_countyId_fkey";

-- AlterTable
ALTER TABLE "OrderAddress" DROP COLUMN "countyId",
